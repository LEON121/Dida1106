...
<body>
	<div class="layui-container" style="margin-top: 5px">
		<form class="layui-form"
			action="${pageContext.request.contextPath }/grade/addGrade"
			method="post">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" name="count" id="f2" lay-verify="name"
						autocomplete="off" placeholder="请输人数" class="layui-input">
				</div>
			</div>
			<div class="layui-form-item">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" name="location" lay-verify="name"
			...
			<div class="layui-form-item">
				<input class="layui-btn" style="margin-left: 10%" type="submit"
					value="确认新增">
			</div>
		</form>
	</div>
	...
	<script>
		...
		//初始化数据
		function initData() {
			$.get("${pageContext.request.contextPath}/grade/courselist", null, function(arr) {
