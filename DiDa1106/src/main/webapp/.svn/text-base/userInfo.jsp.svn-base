		...
		<form class="layui-form" action="studentadd.do" method="post">
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<div class="layui-form-mid layui-word-aux">${lguser.username }</div>
				</div>
			</div>
			<div class="layui-form-item">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<div class="layui-form-mid layui-word-aux">${lguser.lasttime}</div>
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">状态</label>
				<div class="layui-input-inline">
					<div class="layui-form-mid layui-word-aux">${lguser.del == 0? "启用":"禁用"}</div>
				</div>
			</div>
		</form>
	</div>
