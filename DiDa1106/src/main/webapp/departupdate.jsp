...
<body>
	...
	<div class="layui-container" style="margin-top: 5px">
		<form class="layui-form" action="/depart/update" method="post">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
				 <input type="date" name="createtime" value="${depart.createtime }" placeholder="请输入创立日期" id="date" autocomplete="off" class="layui-input">
				</div>
			</div>
