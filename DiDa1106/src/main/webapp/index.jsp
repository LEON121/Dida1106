            ...
            <ul class="layui-nav layui-nav-tree"  lay-shrink="all" id="lm">
            	...
            	<li class="layui-nav-item">
			     <a href="javascript:;" id="1"><i class="layui-icon layui-icon-app"></i>&nbsp;我的工具</a>
			      <dl class="layui-nav-child">
			      	  <dd><a href="javascript:;" id="2" onclick="showTab(1,'clock.jsp','我的日历')">&nbsp;&nbsp;&nbsp;&nbsp;我的日历</a></dd>
			      	  <dd><a href="javascript:;" id="2" onclick="showTab(2,'weather.jsp','天气查询')">&nbsp;&nbsp;&nbsp;&nbsp;天气查询</a></dd>
			      	  <dd><a href="javascript:;" id="2" onclick="showTab(3,'map.jsp','地图查询')">&nbsp;&nbsp;&nbsp;&nbsp;地图查询</a></dd>
			      </dl>
			    </li>
			    <li class="layui-nav-item">
			      ...
			      <dl class="layui-nav-child">
			      	  ...
			      	  <dd><a href="javascript:;" id="2" onclick="showTab(2,'departadd.jsp','部门新增')">&nbsp;&nbsp;&nbsp;&nbsp;部门新增</a></dd>
			      </dl>
			    </li>
			    <li class="layui-nav-item">
			     <a href="javascript:;" id="1"><i class="layui-icon layui-icon-user"></i>&nbsp;员工管理</a>
			      <dl class="layui-nav-child">
			      	  ...
			      	  <dd><a href="javascript:;" id="2" onclick="showTab(2,'empadd.jsp','员工新增')">&nbsp;&nbsp;&nbsp;&nbsp;员工新增</a></dd>
			      </dl>
			    </li>
                <li class="layui-nav-item">
			     <a href="javascript:;" id="1"><i class="fa fa-graduation-cap"></i>&nbsp;专业管理</a>
			      <dl class="layui-nav-child">
			      	  ...
			      	  <dd><a href="javascript:;" id="2" onclick="showTab(2,'courseadd.jsp','专业新增')">&nbsp;&nbsp;&nbsp;&nbsp;专业新增</a></dd>
			      </dl>
			    </li>
			    <li class="layui-nav-item">
			     <a href="javascript:;" id="1"><i class="fa fa-cube"></i>&nbsp;班级管理</a>
			      <dl class="layui-nav-child">
			      	  ...
			      	  <dd><a href="javascript:;" id="2" onclick="showTab(2,'gradeadd.jsp','班级新增')">&nbsp;&nbsp;&nbsp;&nbsp;班级新增</a></dd>
			      </dl>
			    </li>
			    <li class="layui-nav-item">
			     <a href="javascript:;" id="1"><i class="fa fa-user-secret"></i>&nbsp;学生管理</a>
			      <dl class="layui-nav-child">
			      	  ...
			      	  <dd><a href="javascript:;" id="2" onclick="showTab(2,'studentadd.jsp','学生新增')">&nbsp;&nbsp;&nbsp;&nbsp;学生新增</a></dd>
			      	  <dd><a href="javascript:;" id="2" onclick="showTab(2,'studentbatch.jsp','学生导入')">&nbsp;&nbsp;&nbsp;&nbsp;学生导入</a></dd>
			      </dl>
			    </li>
